...
|---|---|---|
|Is CO2 per capita a reliable indicator of a country's total CO2 production?|Created presentation that examined the reliability of the CO2 per capita metric in the World Bank Historical Greenhouse Gas emissions dataset when used as a predictor of total CO2 emissions. Report produced by Tableau and Powerpoint.||
||||
||||
